# 🌿 Vegetation Index Calculator - Render-Ready Version

# 🔄 Install necessary packages if missing (useful for Render or any deployment)
import subprocess
import sys

required_packages = [
    "streamlit", "rasterio", "numpy", "matplotlib", "streamlit-extras"
]

for pkg in required_packages:
    try:
        __import__(pkg if pkg != "streamlit-extras" else "streamlit_extras")
    except ImportError:
